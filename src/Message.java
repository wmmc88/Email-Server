/**
 * Created by melvi on 2017-05-03.
 */
public class Message {
    ...
    public int writeToMessagesFile() {
        ...
        int recordNumber = -1, nextRecordNumber = -1, startRecordNumber = Globals.availableList.getHead() == null ? Globals.totalRecordsInMessagesFile : Globals.availableList.getHead().getRecordNumber();
        Record record = new Record();
        while (s.length() > 0) {
            if (Globals.availableList.getHead() == null) {
                ...
                if (s.length() <= Globals.RECORD_DATA_LEN) {
                    ...
                    nextRecordNumber = Globals.availableList.getHead() == null ? Globals.totalRecordsInMessagesFile : Globals.availableList.getHead().getRecordNumber();
                    record.setData(s.substring(0, Globals.RECORD_DATA_LEN), nextRecordNumber);
                    record.writeToMessagesFile(recordNumber, Globals.MODIFY);
                    s = s.substring(Globals.RECORD_DATA_LEN);
                }
    ...
    public String toString() {
        return "Command: " + command + "\n" +
                ...
                "Marker: " + marker + "\n" +
                "Subject: " + subject + "\n" +
                "End of Subject Marker: " + eosMarker + "\n" +
                "Text: " + text + "\n";
    }
}
